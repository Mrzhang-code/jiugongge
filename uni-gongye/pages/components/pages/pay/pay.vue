<template>
	<view class="container position-relative">
		<view style="margin-bottom: 130rpx;">
			<view class="qu-time">到店自取(约12:30分可取)</view>
				...
				<view class="cart d-flex flex-column">
					<list-cell last v-for="(item, index) in cart" :key="index">
						<view class="w-100 d-flex flex-column">
							<view class="d-flex mb-10">
								<view class="d-flex justify-content-between align-items-center text-color-base font-size-lg mr-20">
									<image style="width: 120rpx;height: 120rpx;border-radius: 10rpx;" mode="aspectFill" :src="item.image"></image>
								</view>
								<view class="flex-fill">
									<view class="d-flex justify-content-between line-height-2">
										<view class="name-and-props overflow-hidden">
											<view class="text-color-base font-size-lg font-weight-bold">{{ item.name }}</view>
										</view>
										<view class="text-right text-color-base font-size-lg">
		...
		<view style="z-index: 1;" class="w-100 pay-box position-fixed fixed-bottom d-flex align-items-center justify-content-between bg-white">
			<view class="flex-fill ml-30">
				<view class="font-weight-bold font-size-lg">实付 <text class="text-color-primary">￥{{ amount }}</text></view>
				<view>总价 <text>￥{{ total }}</text></view>
			</view>
			<view class="bg-primary mr-20 d-flex align-items-center just-content-center text-color-white font-size-base" style="padding: 0 70rpx;height:70rpx;border-radius: 35rpx;" @tap="submit">付款</view>
		</view>
		<!-- 付款栏 end -->
