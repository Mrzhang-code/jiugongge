<template>
	<view class="container" v-if="!loading">
		<view class="main" v-if="goods.length">
			<image class="top_bg" src="/static/images/index/bg_top.png" mode="widthFix"></image>
			<view class="nav">
				<view class="header">
			...
			<view class="action_img">
				<image mode="widthFix" src="/static/images/index/rjhsg.png"></image>
			</view>
			<view class="rqtj_title">
				<view class="left">人气推荐
					<image src="/static/images/index/by_icon.png" mode="widthFix"></image>
				</view>
										...
										<view class="right">
											...
											<view class="price_and_action">
												...
												<view class="btn-group" v-if="good.use_spec && good.stock > 0">
													<!-- <image class="add_car" src="../static/images/menu/add_car.png"></image> -->
